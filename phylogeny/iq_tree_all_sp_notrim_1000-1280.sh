#!/bin/bash
#
#SBATCH --job-name=iqtree_1000-1280
#SBATCH --output=iqtree_all_sp_no_trim_1000-1280.out
...
mapfile -t Orthogroups < ${meta_dir}OGs_all_sp_1000-1280q.txt
...
for OG in "${rev[@]}"; do
    ...
    iqtree2 -s ${mafft_dir}${OG}_aln_us_notrim.fa -m MFP -T AUTO -ntmax 40 -pre ${output_dir}${OG}_iqtree --redo
done