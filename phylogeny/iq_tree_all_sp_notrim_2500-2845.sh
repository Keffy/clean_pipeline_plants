#!/bin/bash
#
#SBATCH --job-name=iqtree_2500-2845
#SBATCH --output=iqtree_all_sp_no_trim_2500-2845.out
...
mapfile -t Orthogroups < ${meta_dir}OGs_all_sp_2500-2845.txt
...
for OG in "${rev[@]}"; do
    ...
    iqtree2 -s ${mafft_dir}${OG}_aln_us_notrim.fa -m MFP -T AUTO -ntmax 24 -pre ${output_dir}${OG}_iqtree --redo
done